...
const AddTaskPopup = ({ isOpen, onClose }) => {
      ...
      <div className="popup__container">
        ...
        <form className="add-task-form form">
          <label className='form__label' htmlFor="task-name">Имя задачи
            <input className='form__field' id="task-name" placeholder="Введите имя задачи" type="text" />
          </label>

          <label className='form__label' htmlFor="task-text">Текст задачи
            <textarea className='form__field form__textarea' id="task-text" placeholder="Введите текст задачи" />
          </label>
          ...
          <label className='form__label form__label-file' htmlFor="task-file">
            ...
            <input className='form__field form__file' id="task-file" type="file" />
          </label>

          <button className='form__submit-btn' type="submit">Добавить задачу</button>
        </form>
      </div>
    </div>
  )
